...
class AssetResponse {
  ...
  // Factory method for when API returns List<dynamic> directly
  factory AssetResponse.fromList(List<dynamic> assetList) {
    return AssetResponse(
      message: 'Success',
      isSuccess: true,
      data: assetList.map((item) => Asset.fromApiJson(item)).toList(),
    );
  }
