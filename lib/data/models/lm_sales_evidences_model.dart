...
class LmSalesEvidencesModel {
  ...
  factory LmSalesEvidencesModel.fromJson(Map<String, dynamic> json) {
    return LmSalesEvidencesModel(
      id: json['id'],
  ...
  LmSalesEvidencesModel copyWith({
    int? id,
    String? assetNumber,
  ...
  @override
  String toString() {
    return 'LmSalesEvidencesModel(assetNumber: $assetNumber, masterFileRef: $masterFileRef, vendor: $vendor, consideration: $consideration, rate: $rate)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is LmSalesEvidencesModel &&
        other.id == id &&
