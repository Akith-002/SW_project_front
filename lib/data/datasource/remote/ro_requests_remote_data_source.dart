...
abstract class RoRequestsRemoteDataSource {
  Future<List<dynamic>> getRatingObjectRequests();
}

class RoRequestsRemoteDataSourceImpl implements RoRequestsRemoteDataSource {
  final DioClient dioClient;
  final Logger _logger = Logger();

  RoRequestsRemoteDataSourceImpl({required this.dioClient});

  @override
  Future<List<dynamic>> getRatingObjectRequests() async {
    try {
      const String endpoint = '/Requests/by-request-type/4';

      _logger.d('======= RO REQUESTS: MAKING API CALL =======');
      ...
      _logger.d('======= RO REQUESTS: API RESPONSE =======');
      ...
      if (response.statusCode == 200) {
        ...
        _logger.e('Failed to load RO requests. Status code: ${response.statusCode}');
        throw ServerException();
      }
    } on DioException catch (e) {
      _logger.e('======= RO REQUESTS: DIO ERROR =======');
      ...
      _logger.e('======= RO REQUESTS: UNEXPECTED ERROR =======');
      _logger.e('Error: $e');
      _logger.e('===========================================');
      throw ServerException();
    }
