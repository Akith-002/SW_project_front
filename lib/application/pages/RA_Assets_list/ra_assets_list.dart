...
class _RaAssetsListState extends BasePageState<RaAssetsList> {
  ...
  void initState() {
    super.initState();
    // Load assets with requestType = 'RA' for rating assessment
    _loadAssets();
  ...
  void _refreshAssets() {
    ...
    _cubit.emit(RaAssetsListLoading());
  ...
  void _navigateToBreadcrumb(int index, String label) {
    ...
    // Second breadcrumb is the sub-section (Mass Rating, Rating Assessment, etc.)
      ...
      String selectedIndex = '3'; // Default to Rating Assessment
      ...
      switch (widget.source) {
        ...
        case 'massRating':
          ...
          break;
        default:
          selectedIndex = '3'; // Default to Rating Assessment for RA
          break;
      }
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            BlocBuilder<RaAssetsListCubit, BaseState<RaAssetsListState>>(
              bloc: _cubit,
              builder: (context, state) {
                if (state is RaAssetsListLoading) {
                  return const Center(
                    child: Padding(
                ...
                } else if (state is RaAssetsListError) {
                  return Center(
                    child: Padding(
                ...
                } else if (state is RaAssetsListLoaded) {
                ...
                } else if (state is RaAssetsListSearchLoaded) {
                  return AssetListTable(
