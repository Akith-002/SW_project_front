...
class AssetMapbox extends StatefulWidget {
...
class AssetMapboxState extends State<AssetMapbox>
  ...
  void didUpdateWidget(covariant AssetMapbox oldWidget) {
    ...
    debugPrint(
        "AssetMapbox didUpdateWidget: isSketchingMode changed: ${oldWidget.isSketchingMode} -> ${widget.isSketchingMode}");
    debugPrint(
    ...
    if (widget.isViewInsideMode != oldWidget.isViewInsideMode) {
      debugPrint(
          "AssetMapbox didUpdateWidget: isViewInsideMode changed -> ${widget.isViewInsideMode}");
