          ...
          children: [
            Expanded(
              ...
              child: Image.asset(
                ...
                fit: BoxFit.cover, // Ensures the image covers its allocated space.
              ),
            ),
            Expanded(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FormSection(), // Custom widget that contains the sign in form.
                    const SizedBox(height: 64), // Spacing between form and footer.
