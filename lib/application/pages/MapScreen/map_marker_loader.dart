...
class MapMarkerLoader {
  ...
  Future<void> loadAllImages() async {
    ...
    try {
      // Adjust paths if needed, ensure 'assets/' prefix IS NOT needed here
      // if rootBundle is used correctly and pubspec.yaml is set up.
      // If it fails, try adding 'assets/'.
      final results = await Future.wait([
        _loadHQMarkerImage("images/pngs/MapPin_RE.png"),
        _loadHQMarkerImage("images/pngs/MapPin_SE.png"),
        _loadHQMarkerImage("images/pngs/MapPin_PV.png"),
        _loadHQMarkerImage("images/pngs/MapPin_BR.png"),
      ]);

      _rentalMarkerImage = results[0];
      _salesMarkerImage = results[1];
      _valuationsMarkerImage = results[2];
      _buildingRatesMarkerImage = results[3];
