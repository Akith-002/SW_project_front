...
class TableScaffoldRA extends StatefulWidget {
  ...
  @override
  State<TableScaffoldRA> createState() => TableScaffoldRAState();
}

class TableScaffoldRAState extends State<TableScaffoldRA> {
  late RaRequestsCubit _cubit;
  ...
  void initState() {
    ...
    _cubit = GetIt.I<RaRequestsCubit>();
    _currentPage = 1;
    _cubit.loadRequests();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: _cubit,
      child: Scaffold(
        body: BlocBuilder<RaRequestsCubit, RaRequestsState>(
          builder: (context, state) {
            if (state is RaRequestsLoading) {
              return const Center(child: CircularProgressIndicator());
            } else if (state is RaRequestsError) {
              return Center(
                child: Column(
            ...
            } else if (state is RaRequestsLoaded) {
