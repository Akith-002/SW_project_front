...
import 'package:land_asset_valuation/application/core/widgets/tableForRB/planRB.dart';
import 'package:land_asset_valuation/application/core/widgets/tableForRB/planRB_repository.dart';
import 'package:land_asset_valuation/application/core/widgets/view_download_button.dart';

class TableScaffoldRB extends StatefulWidget {
  final int initialPageSize;
  final List<int> pageSizeOptions;
  final String pageSource;

  const TableScaffoldRB({
    super.key,
  ...
  @override
  State<TableScaffoldRB> createState() => _TableScaffoldRBState();
}

class _TableScaffoldRBState extends State<TableScaffoldRB> {
  late Future<PaginatedResponseRB<PlanRB>> _futurePlans;
  ...
  void _fetchPlans() {
    setState(() {
      _futurePlans = PlanRBRepository.getPlans(
        pageSize: _pageSize,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder<PaginatedResponseRB<PlanRB>>(
        future: _futurePlans,
        builder: (context, snapshot) {
          ...
          List<PlanRB> plans = snapshot.data!.items;
                                ...
                                children: [
                                  CustomIconButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      context.goNamed(
                                        Pages.routeRbAssetsList.toPathName(),
                                        queryParameters: {
