...
class TableScaffoldRB extends StatefulWidget {
  ...
  @override
  State<TableScaffoldRB> createState() => TableScaffoldRBState();
}

class TableScaffoldRBState extends State<TableScaffoldRB> {
  late RbRequestsCubit _cubit;
  ...
  void initState() {
    ...
    _cubit = GetIt.I<RbRequestsCubit>();
    _currentPage = 1;
    _cubit.loadRequests();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: _cubit,
      child: Scaffold(
        body: BlocBuilder<RbRequestsCubit, RbRequestsState>(
          builder: (context, state) {
            if (state is RbRequestsLoading) {
              return const Center(child: CircularProgressIndicator());
            } else if (state is RbRequestsError) {
              return Center(
                child: Column(
            ...
            } else if (state is RbRequestsLoaded) {
