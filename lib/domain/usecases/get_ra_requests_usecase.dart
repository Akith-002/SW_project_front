...
class GetRaRequestsUseCase {
  final RaRequestRepository repository;

  GetRaRequestsUseCase({required this.repository});

  Future<Either<Failure, RaRequestResponse>> call() async {
    return await repository.getRatingAssessmentRequests();
  }
}