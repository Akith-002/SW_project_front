...
class SavePastValuationsCoordinateUseCase {
  final MarkerCoordinateRepository repository;

  SavePastValuationsCoordinateUseCase(this.repository);
  ...
  Future<Either<Failure, MarkerCoordinateResponse>> call({
    ...
    return await repository.savePastValuationsCoordinate(marker);
  }
}
