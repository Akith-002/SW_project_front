...
class SaveRentalEvidenceCoordinateUseCase {
  final MarkerCoordinateRepository repository;

  SaveRentalEvidenceCoordinateUseCase(this.repository);
  ...
  Future<Either<Failure, MarkerCoordinateResponse>> call({
    ...
    return await repository.saveRentalEvidenceCoordinate(marker);
  }
}
